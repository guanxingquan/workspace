...
class RecordedVideoInfo:
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'from', None, None, ), # 3
    (4, TType.STRING, 'to', None, None, ), # 4
  )
#   def __init__(self, deviceId=None, channelId=None, froms=None, to=None,):
#       pass
  ...
  def write(self, oprot):
    ...
    if self.froms is not None:
      oprot.writeFieldBegin('from', TType.STRING, 3)
